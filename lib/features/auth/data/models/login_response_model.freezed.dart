...
mixin _$LoginResponseModel {
 ...
 String? get token;@JsonKey(name: 'refresh_token') String? get refreshToken; LmsUserModel? get user; String get status; String? get message;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,token,refreshToken,user,status,message);

@override
String toString() {
  return 'LoginResponseModel(token: $token, refreshToken: $refreshToken, user: $user, status: $status, message: $message)';
}
...
@useResult
$Res call({
 String? token,@JsonKey(name: 'refresh_token') String? refreshToken, LmsUserModel? user, String status, String? message
});


$LmsUserModelCopyWith<$Res>? get user;
...
/// Create a copy of LoginResponseModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? token = freezed,Object? refreshToken = freezed,Object? user = freezed,Object? status = null,Object? message = freezed,}) {
  return _then(_self.copyWith(
token: freezed == token ? _self.token : token // ignore: cast_nullable_to_non_nullable
as String?,refreshToken: freezed == refreshToken ? _self.refreshToken : refreshToken // ignore: cast_nullable_to_non_nullable
as String?,user: freezed == user ? _self.user : user // ignore: cast_nullable_to_non_nullable
as LmsUserModel?,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
...
$LmsUserModelCopyWith<$Res>? get user {
  ...
  return $LmsUserModelCopyWith<$Res>(_self.user!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? token, @JsonKey(name: 'refresh_token')  String? refreshToken,  LmsUserModel? user,  String status,  String? message)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginResponseModel() when $default != null:
return $default(_that.token,_that.refreshToken,_that.user,_that.status,_that.message);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? token, @JsonKey(name: 'refresh_token')  String? refreshToken,  LmsUserModel? user,  String status,  String? message)  $default,) {final _that = this;
switch (_that) {
case _LoginResponseModel():
return $default(_that.token,_that.refreshToken,_that.user,_that.status,_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? token, @JsonKey(name: 'refresh_token')  String? refreshToken,  LmsUserModel? user,  String status,  String? message)?  $default,) {final _that = this;
switch (_that) {
case _LoginResponseModel() when $default != null:
return $default(_that.token,_that.refreshToken,_that.user,_that.status,_that.message);case _:
  return null;
...
class _LoginResponseModel implements LoginResponseModel {
  const _LoginResponseModel({this.token, @JsonKey(name: 'refresh_token') this.refreshToken, this.user, this.status = 'success', this.message});
  factory _LoginResponseModel.fromJson(Map<String, dynamic> json) => _$LoginResponseModelFromJson(json);

@override final  String? token;
@override@JsonKey(name: 'refresh_token') final  String? refreshToken;
@override final  LmsUserModel? user;
...
@override $LmsUserModelCopyWith<$Res>? get user;
...
/// Create a copy of LoginResponseModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? token = freezed,Object? refreshToken = freezed,Object? user = freezed,Object? status = null,Object? message = freezed,}) {
